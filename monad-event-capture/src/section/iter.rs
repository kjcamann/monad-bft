...
unsafe impl<'reader, 'section, D> Send for EventCaptureEventIter<'reader, 'section, D> where
    D: EventDecoder + Send
{
}
unsafe impl<'reader, 'section, D> Sync for EventCaptureEventIter<'reader, 'section, D> where
    D: EventDecoder + Sync
{
}
