use monad_event_ring::{
    ...
    event_ring::{monad_event_descriptor, monad_event_ring_header, EventRing, EventContentType},
...
fn load_event_ring_sections(zstd_bytes: &[u8]) -> EventRingFileSections {
    ...
    EventRingFileSections {
        schema_hash: event_ring_header.schema_hash,
        descriptors,
        payload_buf,
    }
}
