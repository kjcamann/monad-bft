...
pub struct txn_start {
    pub ingest_epoch_nanos: u64,    // Epoch nanos before sender recovery
...
pub const EXEC_EVENT_METADATA: [EventMetadata; 21] = [
    EventMetadata {
...
pub static EXEC_EVENT_DOMAIN_METADATA: EventDomainMetadata = EventDomainMetadata {
    metadata_hash: [
        0xdd, 0xc5, 0x8d, 0x9a, 0xfc, 0xab, 0xb6, 0xae, 0x55, 0xd5, 0x25, 0xd2, 0x81, 0xef, 0x9f,
        0xd2, 0xf9, 0xb4, 0xdb, 0xce, 0xb2, 0x7a, 0xc1, 0x18, 0x6, 0x7c, 0xda, 0xfd, 0x70, 0xe9,
        0x1, 0x6b,
    ],
