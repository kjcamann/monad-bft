...
pub struct block_start {
    pub block_tag: block_tag,             // Execution is for this block
...
pub const EXEC_EVENT_METADATA: [EventMetadata; 22] = [
    EventMetadata {
    ...
    EventMetadata {
        ...
        description: "Entry in a EIP-2930 storage access warmup list",
    },
...
pub static EXEC_EVENT_DOMAIN_METADATA: EventDomainMetadata = EventDomainMetadata {
    schema_hash: [
        0xa4, 0xe5, 0xce, 0x6, 0xf7, 0x1e, 0x10, 0x99, 0x75, 0xa0, 0xd6, 0x34, 0x7, 0xed, 0xda,
        0x2d, 0xd9, 0x85, 0x5c, 0x90, 0x9c, 0x4a, 0x82, 0xe6, 0xb4, 0xb7, 0x27, 0x36, 0x57, 0x38,
        0x77, 0x80,
    ],
