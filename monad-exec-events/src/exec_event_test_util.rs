...
use monad_event_ring::{
    ...
    event_ring::{EventRing, EventContentType},
};
...
// devnet (mdn) for a run of 30 blocks (65b), starting from the genesis
// block.
// TODO(ken): we should use reference data that's easy to regenerate; this
//    is a simple flexnet dump, and is not part of the record of any public
//    blockchain
pub const MONAD_DEVNET_30B_GENESIS: ExecEventTestScenario = ExecEventTestScenario {
    name: "MONAD_DEVNET_30B_GENESIS",
    event_ring_snapshot_zst: include_bytes!("test_data/exec-events-mdn-30b-genesis.zst"),
    expected_block_update_json_zst: include_bytes!(
